...
public class MailService {
 ...
 System.out.println("send");
  ...
  public void sendSuggestion(Resource resource,String email){
	  try {
	      Message message = new MimeMessage(session);
	      message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(email));
	      message.setSubject("Resource Suggestion");
	  //    message.setContent(make_cute_email1(email_body_title,email_body_intro_1 , email_receiver , email_body_intro_2, email_company_name, email_company_slogon, company_descrpition, email_link), "text/html; charset=utf-8");
	 System.out.println("send");
	      Transport.send(message);
	    } catch (Exception e) {
	      System.out.println(e);
